...
import { handeGetOperation } from '../../../../handleOperation/handleOperation'
...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      const result = await handeGetOperation(apiLinks.getAllProduct)
    }
    fetchProduct()
    // handleGetOperation('/product/getAllProduct')
  }, [])
